...
const Hero = () => (
    ...
    ${styles.paddingY}`}>
      ...
      flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        [470px] mt-5`}>Our team of experts uses a 
        methodology to identify the credit cards most 
        likely to fit your needs. We examine annual percentage 
        rates, annual fees.</p>
      </div>
      ...
      md:my-0 my-10 relative`}>
        ...
        h-[80%] roundedd-full bottom-40 white__gradient" />
